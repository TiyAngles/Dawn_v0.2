...
- [ ] ~02.12 디자인 가이드 제작 -hwabin
- [ ] ~02.15 로고 제작 -hwabin
- [ ] ~02.15 디자인 psd파일 제작 메인,서브,알럿 디자인, 헤더,푸터,지앤비포함 - Sohyun
- [ ] 퍼블리싱 기획,디자인,퍼블리싱 1차 -Minsang
...
- [ ] 퍼블리싱 -> SCSS 사용하나요?
- [ ] relation 작성필요.
- [ ] ~02.12 구글드라이브 디자인가이드 제작 ~02.15 디자인psd제작,로고제작 -Minsang
