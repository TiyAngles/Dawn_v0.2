...
- [0] 02.24 헤더 푸터 1차 퍼블리싱 및 수정
- [0] ~02.25 1차디자인 수정, 디자인 전페이지 psd 제작 -Sohyun
...
- [ ] 퍼블리싱 -> SCSS 사용하나요?
- [ ] relation 작성필요.
- [0] ~02.12 구글드라이브 디자인가이드 제작 ~02.15 디자인psd제작,로고제작 -Minsang
...
- 2020 02 25 공통 html 파일 수정 header,footer (내용 및 코드 수정), 메인페이지 마크업 작성, style.css 파일 나눔(민상
